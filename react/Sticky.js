...
export const Sticky = props => (
  <svg viewBox="0 0 20 20" {...props}><path d="M1 2.5A1.5 1.5 0 012.5 1h11A1.5 1.5 0 0115 2.5v6.086a1.5 1.5 0 01-.44 1.06l-4.914 4.915a1.5 1.5 0 01-1.06.439H2.5A1.5 1.5 0 011 13.5v-11zM2.5 2a.5.5 0 00-.5.5v11a.5.5 0 00.5.5h6.086a.5.5 0 00.353-.146l4.915-4.915A.5.5 0 0014 8.586V2.5a.5.5 0 00-.5-.5h-11z" fillRule="evenodd" />,
<path d="M9.5 9a.5.5 0 00-.5.5v5H8v-5A1.5 1.5 0 019.5 8h5v1h-5z" fillRule="evenodd" /></svg>
);
